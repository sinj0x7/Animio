...
Command: npx gltfjsx@6.5.3 public/LittlestTokyo.glb -t -r public 
...
export function LittlestTokyo(props: ThreeElements['group']) {
  const group = React.useRef<THREE.Group>(null)
  const { scene, animations } = useGLTF('/LittlestTokyo.glb') as unknown as {
